...
function Hero() {
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-lg">
              Scalp & Skin Relief 8 OZ isn't just a cleanser — it's a scalp reset. Menthol cools, peppermint stimulates, green tea protects, and every follicle gets the deep cleanse it's been waiting for. Feel the difference in the first wash.
            </p>
  ...
  <InteractiveProductDisplay
    ...
    bullets={[
      ...
      'Scalp & Skin Relief 8 OZ tingle refresh',
  ...
  >
    ...
    <div className="product-hero-image animate-float w-80 md:w-[32rem] flex flex-col items-center gap-4">
      <div
        ...
        style={{ 
          background: 'linear-gradient(135deg, #082626, #082626)', 
          borderColor: `${ACCENT}20`, 
          filter: 'drop-shadow(0 30px 50px rgba(0,0,0,0.4))' 
        }}
      >
        <video
          src="/assets/DUDLEYS_Scalp_&_Skin_Relief_Motion.mp4"
          autoPlay
          muted
          loop
          playsInline
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 flex flex-col items-center justify-center bg-black/40 rounded-b-3xl">
          <p className="text-white/60 font-semibold text-sm">Scalp & Skin Relief 8 OZ</p>
        </div>
      </div>
    </div>
  </InteractiveProductDisplay>
...
const BENEFITS = [
  ...
  { icon: <Shield size={26} />, title: 'Natural DHT Blocker', desc: 'Scalp & Skin Relief 8 OZ\'s active compounds have shown ability to inhibit DHT at the scalp, helping create a healthier environment for hair growth and retention.' },
      ...
      <div className="container-pad">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            You can't grow healthy hair from a clogged, irritated scalp. Scalp & Skin Relief 8 OZ fixes the foundation — so everything else you put in your hair actually works.
          </p>
        </AnimatedSection>
            ...
            <div className="bg-white p-8 md:p-12">
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  { phase: 'After rinsing', sensation: 'Total Scalp Freshness', desc: 'Buildup is gone. Sebum cleared. The scalp feels clean and light — not tight or stripped. Scalp & Skin Relief 8 OZ leaves a lasting freshness that no artificial fragrance can replicate.', emoji: '✨' },
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-white/65 text-sm leading-relaxed mb-4">
                  For best results, use Scalp & Skin Relief 8 OZ as the first step in a two-product routine. After rinsing, follow with the Scalp & Skin Relief 8 OZ for a complete wash day that cleanses AND restores moisture balance.
                </p>
                <div className="space-y-2">
                  {[
                    'Lather well and massage into scalp for 60–90 seconds',
                    'Let the menthol activate before rinsing',
                    'Follow with Scalp & Skin Relief 8 OZ for best results',
              ...
              <div>
                <img
                  ...
                  alt="Scalp care application — PLACEHOLDER: Replace with Scalp & Skin Relief 8 OZ application image"
    ...
    <section className="section-pad bg-white">
      <div className="container-pad">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Most shampoos clean your hair. Scalp & Skin Relief 8 OZ treats your scalp — and that's the difference between hair that grows and hair that stays the same.
          </p>
        </AnimatedSection>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <AnimatedSection>
            <div className="rounded-2xl p-7" style={{ background: `${ACCENT}10`, border: `1px solid ${ACCENT}25` }}>
              <p className="text-xs font-bold uppercase tracking-wider mb-5" style={{ color: ACCENT }}>After Scalp & Skin Relief 8 OZ</p>
              <div className="space-y-4">
                {[
...
const TESTIMONIALS = [
  {
    ...
    text: "I had dandruff for YEARS. Tried everything. Two washes with Scalp & Skin Relief 8 OZ and it was basically gone. The cooling sensation is everything — it just feels like it's cleaning your scalp at a cellular level."
  },
  {
  ...
  },
  {
    ...
    text: "I wear braids constantly and my scalp was always irritated and itchy between installs. Scalp & Skin Relief 8 OZ is my go-to wash day shampoo now. Takes the scalp sensitivity completely away. Nothing else I've tried comes close."
  },
]

const FAQS = [
  { question: 'Will this shampoo dry out my hair?', answer: 'No. Scalp & Skin Relief 8 OZ is formulated to deeply cleanse the scalp without stripping the hair strand of natural oils. Avocado\'s fatty acids provide a counterbalancing conditioning effect. However, for the best experience, always follow with the Scalp & Skin Relief 8 OZ to restore full moisture balance.' },
  ...
  { question: 'How do I apply the SPRING2026 code?', answer: 'Go to shop.dudleyq.com, add the Scalp & Skin Relief 8 OZ to your cart, and enter SPRING2026 at checkout for 15% off. Valid for first-time orders during Spring 2026.' },
]
...
export default function PeppermintShampoo() {
  return (
    <div className="min-h-screen">
      ...
      <WelcomePopup productName="Scalp & Skin Relief 8 OZ" accentColor={ACCENT} gradientFrom="#041A1A" shopUrl={SHOP_URL} />
      <ExitIntentPopup productName="Scalp & Skin Relief 8 OZ" accentColor={ACCENT} shopUrl={SHOP_URL} />
      <Hero />
      <Benefits />
      <Ingredients />
      <ScalpHealth />
      ...
      />
      <OfferSection
        productName="Scalp & Skin Relief 8 OZ"
        price="$12.99"
        originalPrice="$15.28"
        shopUrl={SHOP_URL}
        accentColor={ACCENT}
      ...
      <EmailCapture
        ...
        subline="Dandruff, itching, buildup — we have solutions. Get your personalised scalp guide and a first-order discount to start your Scalp & Skin Relief 8 OZ routine today."
      />
