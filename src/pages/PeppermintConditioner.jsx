        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-lg">
              Peppermint Soothe Conditioner restores what the wash cycle removes. Avocado seals moisture, peppermint refreshes the scalp, and green tea protects your strands — leaving you with silky, detangled, manageable hair and a fresh coolness that lingers.
            </p>
          ...
          <div className="flex justify-center">
            <InteractiveProductDisplay
              imageSrc="/assets/IMG_9299 Scalp & Skin Relief.png"
              alt="Peppermint Soothe Conditioner 8oz"
              accent={ACCENT}
              accent2={ACCENT2}
      ...
      <div className="container-pad">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Peppermint Soothe Conditioner seals, softens, and refreshes in a single step. Paired with the shampoo, it completes the full scalp-to-strand restoration.
          </p>
        </AnimatedSection>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-5">
                  The Peppermint Soothe Conditioner doesn't just "condition" your hair — it transforms it. After rinsing, the difference is immediate. Soft. Smooth. Deeply hydrated. A cooling freshness that feels luxurious, not medicinal.
                </p>
          ...
          <div className="rounded-3xl p-8 md:p-10 border border-white/10"
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-white/65 text-sm max-w-lg mx-auto">
                The Peppermint Soothe Conditioner is designed to complete the work started by the Peppermint Soothe Shampoo. Together, they create a full cleanse-restore cycle that leaves your hair in its best possible state after every wash day.
              </p>
            </div>
    ...
    <section className="section-pad bg-white">
      <div className="container-pad">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Whether you're rocking a TWA or waist-length locs, fine waves or 4C coils — Peppermint Soothe Conditioner adapts to your texture, not the other way around.
          </p>
        </AnimatedSection>
...
const FAQS = [
  ...
  { question: 'Can I use it as a co-wash instead of shampoo?', answer: 'While the conditioner isn\'t formulated as a co-wash, some users with very low-porosity hair or low manipulation styles do use it as a rinse-out conditioning cleanse. However, for proper scalp cleansing, we recommend pairing with the Peppermint Soothe Shampoo.' },
  { question: 'Is this a rinse-out or leave-in conditioner?', answer: 'Peppermint Soothe Conditioner 8oz is a rinse-out conditioner. For daily leave-in conditioning, we recommend the Vitamin Power Leave-In Conditioning Spray. The two products work beautifully together as a complete conditioning system.' },
  ...
  { question: 'How does it pair with the Peppermint Soothe Shampoo?', answer: 'They were formulated as a system. The shampoo opens the cuticle and stimulates the scalp; the conditioner seals the cuticle and restores moisture. Together, they deliver a complete, balanced wash day result. The Combo pack is available at a better price.' },
  { question: 'How do I apply the SPRING2026 discount?', answer: 'Add Peppermint Soothe Conditioner 8oz to your cart at shop.dudleyq.com and enter SPRING2026 at checkout for 15% off. Valid for first-time orders in the Spring 2026 period.' },
]
...
export default function PeppermintConditioner() {
  return (
    <div className="min-h-screen">
      ...
      <WelcomePopup productName="Peppermint Soothe Conditioner" accentColor={ACCENT} gradientFrom="#0F1F18" shopUrl={SHOP_URL} />
      <ExitIntentPopup productName="Peppermint Soothe Conditioner" accentColor={ACCENT} shopUrl={SHOP_URL} />
      <Hero />
      <Benefits />
      <Ingredients />
      <HairTypes />
      ...
      />
      <OfferSection
        productName="Peppermint Soothe Conditioner 8 oz"
        price="$12.99"
        originalPrice="$15.28"
        shopUrl={SHOP_URL}
        accentColor={ACCENT}
